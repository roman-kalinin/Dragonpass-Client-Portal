...
import { ArrowLeft, Plane, Building2, Sofa, Car, UtensilsCrossed, Zap, Smartphone, Ticket, Heart, AlertTriangle, ChevronRight, SlidersHorizontal, ChevronDown, BarChart3, ArrowUpRight, ArrowDownRight, TrendingUp } from 'lucide-react';
...
export function EntitlementDetailPage({ entitlement, activeView, onNavigate, onBack }: EntitlementDetailPageProps) {
  ...
  const pct = hasCap && capValue > 0 ? Math.min(100, (entitlement.used / capValue) * 100) : 0;
